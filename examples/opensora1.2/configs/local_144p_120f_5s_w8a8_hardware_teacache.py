# W8A8 CUDA Kernel + TeaCache configuration
# Based on local_144p_120f_5s_w8a8_hardware.py, with TeaCache enabled.
...
save_dir = "/home/rich/ViDiT-Q/.local/outputs/opensora_w8a8_hw_teacache_144p_120f_5s_10steps"
seed = 42
batch_size = 1
num_sample = 1
end_index = 1
...
hardware = True
quant_weight_ckpt = None

# TeaCache options (calibrated 2026-06-12, R^2=0.9902)
...
# Quality mode: teacache_thresh = 0.20 (low hit rate with 10-step)
