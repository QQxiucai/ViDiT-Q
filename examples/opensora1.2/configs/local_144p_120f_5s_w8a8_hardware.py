...
save_dir = "/home/rich/ViDiT-Q/.local/outputs/opensora_w8a8_hardware_144p_120f_5s_10steps"
seed = 42
batch_size = 1
num_sample = 1
end_index = 1
...
# TeaCache options (for quant_inference.py)
enable_teacache = False
teacache_thresh = 0.30
# teacache_coeff = [1.75568353e+02, ...]  # uncomment to use calibrated coefficients
